...
namespace JSON2IFC
{
    public static class Json2IfcHelper
    {
        ...
        public static class TypicalMaterial
        {
        ...
        public const double WINDOW_WIDTH = 0.05;
        public const double DOOR_WIDTH = 0.07;
        public const double FITTING_RADIUS_RATIO = 1.5;
        public const double PIPE_LENGTH_LIMIT = 0.01;
        static jsonStructure readJSONStructure(string strReadFilePath)
        {
        ...
        public static void GenerateIFC(XbimSchemaVersion release, string outputIfcFilePath, string structureFilePath, string mepFilePath)
        {
            using (var ifcStore = createandInitModel("Model"))
            {
                if (ifcStore != null)
                {
                    ...
                    {
                        jsonStructure js = readJSONStructure(structureFilePath);
                    ...
                    {
                        jsonMEP jmep = readJSONMEP(mepFilePath);
